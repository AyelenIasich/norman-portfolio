...
function HackerAvatar() {
  return (
    ...
    >
      <rect width="200" height="200" fill="#0f2323" />

      {/* Outer hex ring decorations */}
      <circle cx="100" cy="100" r="88" fill="none" stroke="#1e3a3a" strokeWidth="1" strokeDasharray="4 6" />

      {/* Monitor body */}
      <rect x="38" y="68" width="124" height="84" rx="6" fill="#1e3a3a" stroke="#14b8a6" strokeWidth="1.5" />
      {/* Screen */}
      <rect x="46" y="76" width="108" height="64" rx="3" fill="#0a1a1a" />

      {/* Terminal text lines */}
      <text x="54" y="94"  fontFamily="monospace" fontSize="9" fill="#14b8a6">$ nmap -sV target</text>
      ...
      {/* Cursor blink block */}
      <rect x="54" y="135" width="6" height="9" fill="#14b8a6" opacity="0.9" />

      {/* Monitor stand */}
      <rect x="88"  y="152" width="24" height="10" fill="#1e3a3a" />
      <rect x="72"  y="162" width="56" height="5" rx="2.5" fill="#1e3a3a" stroke="#1e3a3a" />

      {/* Person silhouette above monitor */}
      <circle cx="100" cy="48" r="18" fill="#1e3a3a" stroke="#14b8a6" strokeWidth="1.5" />
      <text x="91" y="54" fontFamily="monospace" fontSize="16" fontWeight="bold" fill="#14b8a6">N</text>
    </svg>
  )
}
            ...
            <div className="flex justify-center">
              <div
                className="relative w-52 h-52 sm:w-60 sm:h-60 rounded-full
                           border-2 border-teal ring-pulse p-1
                  ...
                  return (
                    <div
                      ...
                      className="bg-surface border border-wire rounded-xl p-4 text-center
                                 hover:border-teal transition-colors duration-300 group"
                    >
                      <Icon className="w-5 h-5 text-teal mx-auto mb-2 group-hover:scale-110 transition-transform" />
                      <div className="font-grotesk text-xl sm:text-2xl font-bold text-teal">
                        {stat.value}
                      </div>
