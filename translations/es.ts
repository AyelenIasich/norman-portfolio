...
export const es: Translations = {
  ...
  cyberlab: {
    ...
    items: [
      {
        title: 'Homelab SIEM con Splunk',
        short: 'Monitoreo de logs y detección de anomalías con pfSense y Snort integrados en un SIEM Splunk.',
      ...
      },
      {
        ...
        short: 'Compromiso de máquina Linux con explotación WordPress y escalada de privilegios SUID.',
        tags: ['Linux', 'WordPress', 'Escalada de Privilegios', 'CTF'],
        badge: 'CTF',
      ...
      {
        title: 'Pentesting WiFi con Wifite',
        short: 'Ataque PMKID en red controlada usando Kali Linux y Wifite en entorno de laboratorio.',
      ...
      },
      {
        ...
        short: 'Explotación EternalBlue MS17-010 con Metasploit para obtener acceso SYSTEM.',
        tags: ['Windows', 'Metasploit', 'EternalBlue', 'Exploit'],
        badge: 'CTF',
        accent: 'green' as const,
        category: 'ctf' as const,
      ...
      {
        title: 'Script de Reconocimiento en Python',
        short: 'Automatización de escaneo Nmap con generación de reportes HTML para la fase de reconocimiento.',
        tags: ['Python', 'Nmap', 'Automatización', 'Scripting'],
        badge: 'Blue Team',
        accent: 'blue' as const,
        category: 'project' as const,
      },
      {
        ...
        short: 'Práctica de SQLi, XSS y CSRF con Burp Suite en DVWA.',
